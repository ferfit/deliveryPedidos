        ...
        <div class="container"  id="cont-producto">
            @foreach($categorias as $categoria)
                ...
                @foreach ($categoria->productos as $producto)      
                    {{-- Contenedor Producto --}}
                    <div   class="col-5 col-md-2 bg-dark text-white menu-item mx-1 mx-md-2 my-3 shadow p-3 rounded d-flex flex-column justify-content-center align-items-center">
                        <img src="/storage/{{ $producto->imagen}}" alt="" class="w-100 rounded d-block mx-auto mb-3 shadow ">
